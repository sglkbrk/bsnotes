...
import { FaAngleDown, FaAngleUp, FaDownload, FaPlus, FaTrash, FaVideo, FaPause, FaPlay } from 'react-icons/fa';
...
const NoteWithVideo = ({ item, editable }: { item: Content; editable: boolean }) => {
